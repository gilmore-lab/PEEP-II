...
% Write ratings
fprintf(env.csv_fid,'%i,%i,%i,%i,%i,%i\n', session.ratings(status.snd_index,1), session.ratings(status.snd_index,2), session.ratings(status.snd_index,3), session.ratings(status.snd_index,4), session.ratings(status.snd_index,5), session.ratings(status.snd_index,6));